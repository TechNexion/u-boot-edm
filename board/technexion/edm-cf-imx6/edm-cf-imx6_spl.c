...
#define IMX6DQ_DRIVE_STRENGTH 0x30U
...
//DDR 64bit 2GB
static struct mx6_ddr_sysinfo edm_sysinfo_q = {
	.dsize		= 2,
	.cs1_mirror	= 0,
...
//DDR 64bit 1GB
static struct mx6_ddr_sysinfo edm_sysinfo_dl = {
	.dsize		= 2,
	.cs1_mirror	= 0,
	/* config for full 4GB range so that get_mem_size() works */
	.cs_density	= 32,
...
//DDR 32bit 512MB
static struct mx6_ddr_sysinfo edm_sysinfo_s = {
	.dsize		= 1,
	.cs1_mirror	= 0,
	/* config for full 4GB range so that get_mem_size() works */
	.cs_density	= 32,
...
static void spl_dram_init(void)
{
	...
	case MXC_CPU_MX6Q:
		...
		mx6_dram_cfg(&edm_sysinfo_q, &mx6q_2g_mmdc_calib, &h5t04g63afr);
		break;
	}
	udelay(100);
}
