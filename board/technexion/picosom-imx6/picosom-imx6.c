...
struct i2c_pads_info mx6q_i2c3_pad_info = {
	.scl = {
		...
		.gpio_mode = MX6Q_PAD_EIM_D17__GPIO3_IO17 | PC,
		.gp = IMX_GPIO_NR(3, 17)
	},
	.sda = {
...
struct i2c_pads_info mx6dl_i2c3_pad_info = {
	.scl = {
		.i2c_mode = MX6DL_PAD_EIM_D17__I2C3_SCL | PC,
		.gpio_mode = MX6DL_PAD_EIM_D17__GPIO3_IO17 | PC,
		.gp = IMX_GPIO_NR(3, 17)
	},
	.sda = {
...
static iomux_v3_cfg_t const fwadapt_7wvga_pads[] = {
	...
	IOMUX_PADS(PAD_DI0_PIN4__IPU1_DI0_PIN04
	...
	IOMUX_PADS(PAD_SD4_DAT3__GPIO2_IO11
